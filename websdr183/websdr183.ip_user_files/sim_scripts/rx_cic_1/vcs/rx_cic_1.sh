...
design_libs=(xilinx_vip xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 cic_compiler_v4_0_17 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"C:/Xilinx/vt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"C:/Xilinx/vt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vhdlan -work cic_compiler_v4_0_17 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rx_cic_1 xil_defaultlib.glbl -o rx_cic_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rx_cic_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rx_cic_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rx_cic_1_simv.daidir vcs_lib c.obj)
