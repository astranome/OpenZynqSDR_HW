...
#
# Script generated by Vivado on Sun Feb 15 06:16:34 +0300 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rx_cic_1.sh
...
#
# Usage        : rx_cic_1.sh
#                rx_cic_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rx_cic_1.sh [-reset_run]
#                rx_cic_1.sh [-reset_log]
#                rx_cic_1.sh [-help]
#
...
#                script (type 'rx_cic_1.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xbip_utils_v3_0_11 -libname axi_utils_v2_0_7 -libname cic_compiler_v4_0_17 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 cic_compiler_v4_0_17 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "rx_cic_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rx_cic_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"C:/Xilinx/vt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"C:/Xilinx/vt/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvhdl -work cic_compiler_v4_0_17 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rx_cic_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rx_cic_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rx_cic_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rx_cic_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rx_cic_1.sh [-help]\n\
Usage: rx_cic_1.sh [-step]\n\
Usage: rx_cic_1.sh [-lib_map_path]\n\
Usage: rx_cic_1.sh [-reset_run]\n\
Usage: rx_cic_1.sh [-reset_log]\n\
Usage: rx_cic_1.sh [-keep_index]\n\
Usage: rx_cic_1.sh [-noclean_files]\n\n\
