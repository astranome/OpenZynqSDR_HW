...
#
# Script generated by Vivado on Sun Feb 15 06:14:33 +0300 2026
...
#
# Usage        : rx_cic2.sh
#                rx_cic2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rx_cic2.sh [-reset_run]
#                rx_cic2.sh [-reset_log]
#                rx_cic2.sh [-help]
#
...
#                script (type 'rx_cic2.sh -help' for more information).
#
...
# script info
echo -e "rx_cic2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rx_cic2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rx_cic2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rx_cic2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rx_cic2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rx_cic2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rx_cic2.sh [-help]\n\
Usage: rx_cic2.sh [-step]\n\
Usage: rx_cic2.sh [-lib_map_path]\n\
Usage: rx_cic2.sh [-reset_run]\n\
Usage: rx_cic2.sh [-reset_log]\n\
Usage: rx_cic2.sh [-keep_index]\n\
Usage: rx_cic2.sh [-noclean_files]\n\n\
